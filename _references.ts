...
/// <reference path="src/de/mayflower/mfg/new_game/MfgWorld.ts" />
/// <reference path="src/de/mayflower/mfg/new_game/MfgCheckpoint.ts" />
/// <reference path="src/de/mayflower/mfg/new_game/MfgDemo.ts" />
/// <reference path="src/de/mayflower/mfg/new_game/MfgCar.ts" />
...
/// <reference path="src/de/mayflower/mfg/old_g3d/MfgMaterial.ts" />
/// <reference path="src/de/mayflower/mfg/old_g3d/MfgScene.ts" />
/// <reference path="src/de/mayflower/mfg/old_g3d/MfgSceneFactory.ts" />
/// <reference path="src/de/mayflower/mfg/old_g3d/MfgSprite.ts" />
/// <reference path="src/de/mayflower/mfg/old_game/MfgGame.ts" />
/// <reference path="src/de/mayflower/mfg/old_game/MfgCamera.ts" />
/// <reference path="src/de/mayflower/mfg/old_game/level/MfgLevel.ts" />
/// <reference path="src/de/mayflower/mfg/old_game/level/MfgLevelBunny.ts" />
/// <reference path="src/de/mayflower/mfg/old_game/level/MfgLevelFirstPerson.ts" />
