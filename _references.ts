...
/// <reference path="src/de/mayflower/mfg/new_game/MfgApp.ts" />
/// <reference path="src/de/mayflower/mfg/new_game/MfgCamera.ts" />
...
/// <reference path="src/de/mayflower/mfg/new_game/MfgScene.ts" />
