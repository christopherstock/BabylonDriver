function Chekpoints(e, t, i, s, o, n, r, a, h) {
    "use strict";
    h = h || {}, this.scene = e, this.carBox = t, this.ground = i, this.poiPath = s, this.poiMesh = o, this.spriteFile = n, this.nbSprites = r, this.spriteSize = a, this.msgCallback = "function" == typeof h.msgCallback ? h.msgCallback : null, this.chekpointsCallback = "function" == typeof h.chekpointsCallback ? h.chekpointsCallback : null, this.onLoadFinished = "function" == typeof h.onLoadFinished ? h.onLoadFinished : null, this.enabled = !1, this.carBox.actionManager = null
}
